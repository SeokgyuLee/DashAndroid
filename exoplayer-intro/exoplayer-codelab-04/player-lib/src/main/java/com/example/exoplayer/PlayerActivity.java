...
//  }
  ...
  private void initializePlayer()  {
    ...
    MediaSource source = buildMediaSource(Uri.parse("http://210.94.185.47/test/test.mpd"));
  ...
  private void releasePlayer() {
    if (player != null) {
      ...
      //MediaSource mediaSource = buildMediaSource(Uri.parse("http://210.94.185.47/test/test.mpd"));
